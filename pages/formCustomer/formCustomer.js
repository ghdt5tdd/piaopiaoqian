...
Page({
  data: {
    ...
    dateStatus: false,
    month_search: '请选择月份',
    customerSendTh: ["序号", "月份", "承运商名称", "收货单位", "发货站", "终点站", "及时数", "不及时数", "运单数", "签收数", "未签收数", "已签收及时率", "总及时率", "签收率"],
    customerReturnTh: ["序号", "月份", "承运商名称", "收货单位", "发货站", "终点站", "及时数", "不及时数", "运单数", "签收数", "未签收数", "已签收及时率", "总及时率", "签收率"],
    customerSignTh: ["序号", "月份", "承运商名称", "收货方客户卡号", "收货方客户名称", "承运商卡号", "已签收", "待签收", "总数", "签收率"],
    areaSendTh: ["序号", "月份", "物流仓名称", "承运商名称", "发货站", "终点站", "及时数", "不及时数", "运单数", "签收数", "未签收数", "已签收及时率", "总及时率", "签收率"],
    areaReturnTh: ["序号", "月份", "物流仓名称", "承运商名称", "发货站", "终点站", "及时数", "不及时数", "运单数", "签收数", "未签收数", "已签收及时率", "总及时率", "签收率"],
    areaSignTh: ["序号", "月份", "承运商名称", "收货方客户卡号", "收货方客户名称", "已签收", "待签收", "总数", "签收率"],
    forwarderTh: ["序号", "月份", "承运商名称", "发货站", "终点站", "及时数", "不及时数", "运单数", "签收数", "未签收数", "已签收及时率", "总及时率", "签收率"],
    analysisTh:[],
    analysisData: [],
    page: 1,
    carrier: ['请选择承运商'],
